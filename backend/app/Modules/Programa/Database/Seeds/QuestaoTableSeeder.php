    ...
    public function run()
    {
        foreach ($this->getQuestoes() as $questao) {
            Question::firstOrCreate([
                ...
                'id_orgao' => Agency::firstOrCreate(['sg_orgao' => $questao['sg_orgao']])->id_orgao,
                'id_banca' => ExaminingBoard::firstOrCreate(['no_banca' => $questao['no_banca']])->id_banca,
                'id_assunto' => Subject::firstOrCreate(['no_assunto' => $questao['no_assunto']])->id_assunto,
            ]);
        }
    }
